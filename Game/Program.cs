...
namespace Game
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                case "1":
                    Console.WriteLine("  Крестьянин: А ты оказывается эгоист, не ожидал я такого.");
                    break;
                case "2":
                    Console.WriteLine("  Крестьянин: Вот я так же думаю. А насчёт вероятности... А, чёрт его знает!");
                    break;
            }
